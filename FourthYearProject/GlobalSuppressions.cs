...
[assembly:
    SuppressMessage("Critical Code Smell", "S1186:Methods should not be empty", Justification = "<Pending>",
        Scope = "member",
        Target = "~M:_4thYearProject.Server.Pages.Index.OnInitializedAsync~System.Threading.Tasks.Task")]
[assembly:
    SuppressMessage("Minor Code Smell", "S1104:Fields should not have public accessibility",
        Justification = "<Pending>", Scope = "member",
        Target = "~F:_4thYearProject.Server.Pages.PostDetail.extendComment")]