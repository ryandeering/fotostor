            ...
            if (!context.Users.Any())
            {
                ...
                var newUser2 =
                    new UserData
                    {
                        ...
                        ProfilePic =
                            "https://storage.googleapis.com/download/storage/v1/b/4thyearprojectrd/o/e0720e90-a0b9-43ae-8b61-84777cab9be9190.JPEG?generation=1616551099533747&alt=media",
                        Address = new Address
                        {
                ...
                var newUser3 =
                    new UserData
                    {
                        ...
                        ProfilePic =
                            "https://storage.googleapis.com/download/storage/v1/b/4thyearprojectrd/o/d6ee504c-81c4-4490-9d01-d60b88977274136.JPEG?generation=1618677712128764&alt=media",
                        Address = new Address
                        {
                ...
                var newUser4 =
                    new UserData
                    {
                        ...
                        Bio = "Photographer from Belfast.",
                        ProfilePic =
                            "https://storage.googleapis.com/download/storage/v1/b/4thyearprojectrd/o/ad2f4d7f-1a8a-4fa1-afb0-defd2976bd9c188.JPEG?generation=1618948633840672&alt=media",
                        Address = new Address()
                    };
                ...
                var newUser5 =
                    new UserData
                    {
                        ...
                        ProfilePic =
                            "https://storage.googleapis.com/download/storage/v1/b/4thyearprojectrd/o/35907067-a305-4d96-9a44-6996925058cd147.JPEG?generation=1618952489782818&alt=media",
                        Address = new Address()
                    };
                ...
                var joaoPost3 = new Post
                {
                    UserId = "5df6a9d8-5492-4247-a860-38c2c2621887",
                    PhotoFile =
                        "https://storage.googleapis.com/download/storage/v1/b/4thyearprojectrd/o/35907067-a305-4d96-9a44-6996925058cd_0161.JPEG?generation=1618952675784198&alt=media",
                    Thumbnail =
                ...
                var joaoPost4 = new Post
                {
                    UserId = "5df6a9d8-5492-4247-a860-38c2c2621887",
                    PhotoFile =
                        "https://storage.googleapis.com/download/storage/v1/b/4thyearprojectrd/o/35907067-a305-4d96-9a44-6996925058cd_0186.JPEG?generation=1618952698449723&alt=media",
                    Thumbnail =
                        "https://storage.googleapis.com/download/storage/v1/b/4thyearprojectrd/o/35907067-a305-4d96-9a44-6996925058cd_0186T.JPEG?generation=1618952698955355&alt=media",
                    MimeType = "image/jpeg",
                    Caption = "",
                    LicenseEnabled = true,
                    PrintsEnabled = true,
